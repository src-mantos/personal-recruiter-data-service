...
export class ScrapeDao {
    ...
    async upsert (entity: ScrapeRequest | IScrapeRequest): Promise<void> {
    ...
    async insert (entity: ScrapeRequest | IScrapeRequest): Promise<void> {
        const cast = entity as ScrapeRequest;
        if (!cast._id) {
    ...
    async update (entity: ScrapeRequest | IScrapeRequest): Promise<void> {
